...
| `Diffuser_Spec` | PipeDiaCalc/DiffuserInsertCommand.cs | `"2400,RPD,RA,3"`(CFM,Type,SystemType,개수) 형식 Text 를 검증한 뒤 XData `Diffuser`=Type 기록. 형식 오류는 이유 출력 후 건너뜀 (2026-09-22 신규, [[InsertDiffuser]] §7) |
