...
public static class DuctSizingCalculator
{
    ...
    public static DuctSizingResult ModeA(double q, double r, double alpha, int b)
    {
        var ctx = ComputeContext(q, r, alpha);
    ...
    public static DuctSizingResult ModeB(double q, double r, double alpha, double aspectMax)
    {
        var ctx = ComputeContext(q, r, alpha);
    ...
    public static DuctSizingResult ModeC(double q, double r, double alpha, double aspectMax)
    {
        var b = ModeB(q, r, alpha, aspectMax);
    ...
    private static (double de, int d, double deMax, AuxiliaryValues aux) ComputeContext(double q, double r, double alpha)
    {
