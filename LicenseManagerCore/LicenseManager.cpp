...
String^ LicenseHelper::EncryptString(String^ text) {
    ...
    System::IO::Stream^ stream = csEncrypt;
    System::IO::StreamWriter^ swEncrypt = gcnew System::IO::StreamWriter(csEncrypt, Encoding::UTF8);
...
String^ LicenseHelper::DecryptString(String^ cipherText) {
    ...
    System::IO::Stream^ stream = csDecrypt;
    System::IO::StreamReader^ srDecrypt = gcnew System::IO::StreamReader(csDecrypt, Encoding::UTF8);
