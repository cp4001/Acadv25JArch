...
{
    /// <summary>
    /// PaletteSet 관리 클래스 (Singleton 패턴)
    /// </summary>
    public class PipeTreeViewPalette
    {
        private static PaletteSet paletteSet;
        private static PipeTreeView treeViewControl;
        private static ElementHost elementHost;
        private static readonly Guid PALETTE_GUID = new Guid("A1B2C3D4-E5F6-4A5B-8C9D-0E1F2A3B4C5D");

        /// <summary>
        /// PaletteSet 생성 또는 표시
        /// </summary>
        public static void ShowPalette(PipeGraph graph, PipeNode rootNode)
        {
            if (paletteSet == null)
            {
                // PaletteSet 생성
                ...
                // WPF UserControl 생성
                treeViewControl = new PipeTreeView();
